...
class Setup:
    ...
    def fit(self,**kwargs):
        ...
        if 'version' in kwargs:
            self.sgdversion = kwargs['version']
        if 'beta_choice' in kwargs:
            self.beta_choice = kwargs['beta_choice']

        # run gradient descent
        weight_history, cost_history = optimizers.gradient_descent(self.cost,self.alpha_choice,self.max_its,self.w_init,self.sgdversion,self.beta_choice)
